            ...
            <div class="mb-4">
                ...
                <div class="mt-2">
                    <div class="flex items-center">
                        <input id="admin" name="is_admin" type="radio" value="1" class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300" {{ old('is_admin') == '1' ? 'checked' : '' }}>
                        <label for="admin" class="ml-3 block text-sm font-medium text-gray-700">
                            Admin
                        </label>
                    </div>
                    <div class="flex items-center mt-2">
                        <input id="user" name="is_admin" type="radio" value="0" class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300" {{ old('is_admin') == '0' ? 'checked' : '' }}>
