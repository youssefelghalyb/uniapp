<x-app-layout>
    <div class="bg-white rounded-lg shadow p-6">
        <h2 class="text-xl font-bold mb-6">Add Assistant</h2>
        ...
        <form action="{{ route('assistants.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="assistant_id" id="assistant_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
