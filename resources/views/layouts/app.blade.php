...
<body class="bg-gray-100">
    <div x-data="{ sidebarOpen: false }" class="flex h-screen flex-col md:flex-row">
        ...
        <aside 
            ...
            <div class="flex items-center justify-start bg-gray-200 p-4 rounded-lg">
            ...
            <nav>
                ...
                <a href="{{ route('branches.index') }}" class="block py-2 px-4 rounded {{ request()->routeIs('branches.*') ? 'bg-gray-800' : 'hover:bg-gray-700' }}">branches</a>
                ...
                <hr class="my-2 border-gray-700">
                <a href="{{ route('requests.index') }}" class="block py-2 px-4 rounded {{ request()->routeIs('requests.*') ? 'bg-gray-800' : 'hover:bg-gray-700' }}">Requests</a>
                <a href="{{ route('meetings.index') }}" class="block py-2 px-4 rounded {{ request()->routeIs('meetings.*') ? 'bg-gray-800' : 'hover:bg-gray-700' }}">Meetings</a>
